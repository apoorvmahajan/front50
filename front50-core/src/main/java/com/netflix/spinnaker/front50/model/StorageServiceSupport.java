...
public abstract class StorageServiceSupport<T extends Timestamped> {
  ...
  public StorageServiceSupport(
    ...
    // Setting the threadpool size to 1 here doesn't matter since the scheduler
    // is already created with the actual pool size before calling this
    this.configProperties =
        new StorageServiceConfigurationProperties.PerObjectType(
            1, refreshIntervalMs, shouldWarmCache);
  ...
  public StorageServiceSupport(
    ...
    this(
        ...
        scheduler,
        objectKeyLoader,
        configurationProperties.getRefreshMs(),
        configurationProperties.isShouldWarmCache(),
        registry,
